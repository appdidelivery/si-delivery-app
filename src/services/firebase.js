...
// 2. Sua configuração específica do Firebase (que você forneceu)
const firebaseConfig = {
  apiKey: "AIzaSyD_LdDobMQqltW6ejDwibcyoeUoX_BoHEs",
  authDomain: "zetesteapp.firebaseapp.com",
  projectId: "zetesteapp",
  storageBucket: "zetesteapp.appspot.com", // Corrigido para o padrão .appspot.com
...
const auth = getAuth(app); // Esta linha estava faltando
