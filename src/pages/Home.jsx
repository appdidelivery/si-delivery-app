...
alert("Pagamento recusado pelo Mercado Pago. Tente outro cartão ou entre em contato com seu banco. Erro: " + motivoErro);
  ...
  // CORREÇÃO SEO AUDIT: Este bloco foi desativado com 'return' preventivo pois gerava 
  // Canibalização de Schema (duplicidade) com a tag @graph gerada no componente SEO.jsx.
  // As estrelas e o AggregateRating agora são processados exclusivamente e com segurança no SEO.jsx.
  useEffect(() => {
      return; 
